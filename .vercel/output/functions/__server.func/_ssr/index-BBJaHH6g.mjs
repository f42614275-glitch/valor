...
function Promo() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-editorial pb-32 md:pb-48", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: "/audio/file.mp4", poster: "/audio/poster.jpg", controls: playing, playsInline: true, preload: "metadata", onPlay: () => setPlaying(true), className: "absolute inset-0 h-full w-full bg-black object-contain" }),
